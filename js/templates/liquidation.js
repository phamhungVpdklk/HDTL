function generateLiquidationHTML(data) {
    ...
    data.allOptionalItems.forEach(parcel => {
        parcel.services.forEach(service => {
            ...
            const description = service.type === 'area_based'
                ? `${escapeHTML(service.name)} (Tờ ${escapeHTML(parcel.mapSheet)}, Thửa ${escapeHTML(parcel.parcelNo)}, Dt ${parcel.area} m², tại ${escapeHTML(parcel.address)})`
                : `${escapeHTML(service.name)} (Tờ ${escapeHTML(parcel.mapSheet)}, Thửa ${escapeHTML(parcel.parcelNo)}, tại ${escapeHTML(parcel.address)})`;
    ...
    return `<html><head><title>Biên bản thanh lý hợp đồng</title><style>@page{size:A4 portrait;margin-left:1.5cm;margin-top:1cm;margin-right:1cm;margin-bottom:1cm}body{font-family:'Times',serif;font-size:12pt;line-height:1.3;color:#000}.bold{font-weight:700}.italic{font-style:italic}.header-table{width:100%;border-collapse:collapse;font-size:11pt;table-layout:fixed}.header-table td{border:none;padding:0;vertical-align:top;text-align:center}.org-main{font-weight:700}.line-separator{border-top:1px solid #000;margin:1px auto}.main-title{font-size:14pt;font-weight:700;text-align:center;margin:20px 0}.content p{text-indent:30px;margin:2px 0;text-align:justify}.parties-table{width:100%;border:none}.parties-table td{border:none;padding:1px 0;vertical-align:top}.cost-table{width:100%;border-collapse:collapse;margin:10px 0}.cost-table th,.cost-table td{border:1px solid #333;padding:3px 4px;text-align:left;vertical-align:top;font-size:11pt;line-height:1.2}.cost-table th{background-color:#f2f2f2;text-align:center;font-weight:700}.cost-table td:nth-child(1),.cost-table td:nth-child(3),.cost-table td:nth-child(4){text-align:center}.align-right{text-align:right}.total-row{font-size:1.1em}.currency{text-align:right!important}.footer-table{width:100%;border:none;margin-top:20px}.footer-table td{text-align:center;font-weight:700;border:none;padding:0}.page-break{page-break-before:always}</style></head><body> <div class="header"> <table class="header-table"> <tr> <td style="width: 50%;"> <div class="bold">VĂN PHÒNG ĐĂNG KÝ ĐẤT ĐAI</div> <div class="bold org-main">TỈNH ĐỒNG NAI CHI NHÁNH LONG KHÁNH</div> <div class="line-separator" style="width: 45%;"></div> <div>Số: ${escapeHTML(data.contractInfo.fullLiquidationNumber)}</div> </td> <td style="width: 50%;"> <div class="bold">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT&nbsp;NAM</div> <div style="display: inline-block; text-align: center;"> <div class="bold">Độc lập - Tự do - Hạnh phúc</div> <div class="line-separator" style="width: 100%;"></div> </div> </td> </tr> </table> </div> <p style="text-align: right;" class="italic">${escapeHTML(data.contractInfo.location)}, ngày ${liquidationDate.ngay} tháng ${liquidationDate.thang} năm ${liquidationDate.nam}</p> <div class="main-title">BIÊN BẢN THANH LÝ HỢP ĐỒNG</div> <div class="content"> <p>Căn cứ vào hợp đồng đã ký số ${escapeHTML(data.contractInfo.fullNumber)} ngày ${contractDate.ngay} tháng ${contractDate.thang} năm ${contractDate.nam}</p> <p>Hôm nay, ngày ${liquidationDate.ngay} tháng ${liquidationDate.thang} năm ${liquidationDate.nam}, chúng tôi gồm:</p> </div> <div class="parties"> <table class="parties-table"> <tr><td colspan="2"><strong class="bold"><u>Bên A:</u></strong></td></tr> <tr><td style="width: 90px;">Ông (Bà):</td><td><strong class="bold">${escapeHTML(data.clientInfo.name)}</strong></td></tr> <tr><td>Địa chỉ:</td><td>${escapeHTML(data.clientInfo.address)}</td></tr> <tr><td colspan="2" style="height: 10px;"></td></tr> <tr><td colspan="2"><strong class="bold"><u>Bên B: VĂN PHÒNG ĐĂNG KÝ ĐẤT ĐAI TỈNH ĐỒNG NAI – CN LONG KHÁNH</strong></u></td></tr> <tr><td>Đại diện:</td><td>Ông <span class="bold">${escapeHTML(AppConfig.REPRESENTATIVE_INFO.name)}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Chức vụ: ${escapeHTML(AppConfig.REPRESENTATIVE_INFO.position)}</td></tr> <tr> <td colspan="2" class="italic">${escapeHTML(authText)}</td> </tr> <tr><td>Địa chỉ:</td><td>Đường CMT8, phường Xuân An, thành phố Long Khánh, tỉnh Đồng Nai</td></tr> <tr><td>Điện thoại:</td><td>0251.3877249</td></tr> <tr><td>Tài khoản số:</td><td>0121000677979 tại Ngân hàng Vietcombank Đồng Nai- PGD Long Khánh</td></tr> <tr><td>Mã số thuế:</td><td>3600727427-004</td></tr> </table> </div> <div class="content"> <p>Bên B đã thực hiện khối lượng và giá trị công trình theo các hạng mục sau:</p> </div> <table class="cost-table"> <thead> <tr> <th>Số TT</th> <th>Nội dung công việc</th> <th>ĐVT</th> <th>K. lượng</th> <th>Đơn giá (đồng)</th> <th>Thành tiền (đồng)</th> </tr> </thead> <tbody> ${rowsHTML} </tbody> </table> <p class="amount-in-words" style="text-align: center;" class="italic bold">(Bằng chữ: ${numberToWords(data.grandTotal)})</p> 
            <div class="content"> 
