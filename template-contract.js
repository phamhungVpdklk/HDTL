function generateContractHTML(data) {
    ...
    return `<html><head><title>Hợp đồng đo đạc</title><style> 
            ...
            .main-title { font-size: 14pt; font-weight: bold; text-align: center; margin: 10px 0; } 
            .content p { margin: 2px 0; text-align: justify; } 
            .content .indent {text-indent: 15px;} 
            .cost-table { width: 100%; border-collapse: collapse; margin: 10px 0; } 
            .cost-table th, .cost-table td { border: 1px solid #333; padding: 3px 4px; text-align: left; vertical-align: top; font-size: 11pt; line-height: 1.0;} 
            ...
            .party-info p { margin: 2px 0; text-align: justify; }
            .party-detail { padding-left: 20px; }
            .page-2-content {
                font-size: 13pt;
                line-height: 1.15;
            }
            .page-2-content .content p { margin: 1.5px 0; }
            .page-2-content .footer-table { margin-top: 20px; }
        </style></head>
        <body>
            ...
            <div class="main-title">HỢP ĐỒNG<br>Đo đạc thửa đất BĐĐC tại ${data.contractInfo.location}</div>
            ...
            <div class="party-info">
                ...
                <p class="party-detail">- Ông (Bà): <strong class="bold">${data.clientInfo.name}</strong></p>
                <p class="party-detail">- Địa chỉ: ${data.clientInfo.address}</p>
                <p class="party-detail">- Số điện thoại: ${data.clientInfo.phone}</p>
                <br>
                <p><strong class="bold"><u>Bên B: VĂN PHÒNG ĐĂNG KÝ ĐẤT ĐAI TỈNH ĐỒNG NAI – CN LONG KHÁNH</strong></u></p>
                <p class="party-detail">- Đại diện: Ông <span class="bold">Phạm Văn Hải</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Chức vụ: Phó Giám đốc</p>
